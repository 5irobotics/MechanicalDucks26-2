...
@Autonomous(name = "TopBlue", group = "Examples")
public class TopBlue extends OpMode {
    ...
    private final Pose startPose = new Pose(39.19887165021157, 134.86036671368123, Math.toRadians(90)); // Start Pose of our robot.
    private final Pose shootPose1 = new Pose(70.07052186177715, 66.00846262341325, Math.toRadians(130)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose pickup1Pose = new Pose(39.605077574047954, 85.10014104372355, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(20.919605077574047, 85.10014104372355, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose shootPose2 = new Pose(70.07052186177715, 65.80535966149506, Math.toRadians(130)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose lineupPose = new Pose(41.02679830747532, 59.712270803949224, Math.toRadians(180)); // Lowest (Third Set) of Artifacts from the Spike Mark.
